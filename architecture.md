...
## 8. Capa UI Inicio / navegación lateral (REQ-UI-01..100, v1.39 25/09/2026)
...
- v1.33: expanders tabulados como secundarios; perrito con CSS global en el sidebar;
  leyenda con conteos (`build_leyenda_html()` puro).
- v1.34: publicar negro + puntúa compacto; MÁS inline con contraste y perro por
  iframe; pie admin con métricas, badge y donaciones.
- v1.35: MÁS en claro sin fugas; puntúa en vertical; pie tras el login.
- v1.36: MÁS otra vez en negro; pie en el sidebar tras ADMINISTRACIÓN.
- v1.37: líneas alternas en MÁS + pie centrado con segundo divisor.
- v1.38: badge contenido + soporte CONTACTO/URL rojas.
- v1.39: métricas compactas + URLs que parten.
