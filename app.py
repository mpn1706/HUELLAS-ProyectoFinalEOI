...
.huellas-hero { padding:0.1rem 0 0.3rem; }
.huellas-title { font-family:'Montserrat','Inter',sans-serif; font-weight:800; color:#23201B; line-height:1.2; letter-spacing:0.01em; font-size:clamp(1.6rem,4vw,2rem); margin:0.2rem 0 0.2rem; }
.huellas-sub { font-size:0.95rem; color:#57503F; margin:0 0 0.5rem; }
