"""Demo E2E ÉXITO-01: lost_001 debe recuperar found_001 arriba del ranking."""
import sys
...
assert top == "found_001", f"ÉXITO-01 falla: top={top}"
assert ms[0]["score"] >= 0.65
print("E2E OK: found_001 es top-1 con score >=65%")
