...
## S132 — 26/09/2026 — Carteles MOST WANTED junto al hero (Muse Spark)
- Los 3 pergaminos (`animacion_pergamino/pergamino_01..03.jpg`, renombrados a canónico) se desenrollan de arriba abajo por turnos (12s, uno cada 4s) a la derecha del título, con `build_pergaminos_html()` + `scaleY` desde arriba. En móvil apilan debajo.
- Verificación: `test_carousel.py` 11/11.
