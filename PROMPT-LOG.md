...
## S121 — 26/09/2026 — Header sin corte con sidebar abierto (Muse Spark)
- El contenido iba tan pegado arriba (`padding-top:0.2rem`) que con el sidebar desplegado el header quedaba bajo la barra fija y se cortaba. Aire a 1rem.
